...
package object Constants {
    ...
    val STOPWORDS_ROOT = SAMPLES_ROOT + "stoplists/"
    val IMAGE_SERILIZED_FILE_ROOT = SAMPLES_ROOT + "image_features/"
    val EXTRACTED_TEXT_FILE_ROOT = SAMPLES_ROOT + "text_features/"
    val IMAGE_FEATURE_ROOT = SAMPLES_ROOT + "image_features/"
    val CLUSTER_FIlE = SAMPLES_ROOT + "image_cluster/clusters.ser"
    val LDA_MODEL_FIlE = SAMPLES_ROOT + "text_model/lda_model.ser"
    ...
    val GROUND_TRUTH_ROOT = SAMPLES_ROOT + "ground_truth/"
