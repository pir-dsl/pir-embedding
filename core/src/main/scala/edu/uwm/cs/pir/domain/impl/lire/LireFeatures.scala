...
//
//class LireImage(val p: Location) extends Domain with IImage[Location] {
//
...
//
//    }
//    new IImage[BufferedImage] {}
//  }
//}
//
//case class LireText(val p: Location) extends Domain with IText[Location] {
...
//    var bufferedImage = image.f_getFeature.f_getFeature
//    try {
...
//}
//
//case class LireCEDD(val scaleWidth: Int, val scaleHeight: Int) extends Domain with IFeature[net.semanticmetadata.lire.imageanalysis.CEDD] {
